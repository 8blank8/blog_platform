...
export class QuizController {
    ...
    async updateQuestion(
        ...
        const isUpdated = await this.commandBus.execute(new UpdateQuestionCommand(id, inputData))
    ...
    async findAllQuestion(
        @Query() queryParam: QuestionQueryParam
    ) {
        const questions = await this.quizQueryRepository.findAllQuestion(queryParam)
