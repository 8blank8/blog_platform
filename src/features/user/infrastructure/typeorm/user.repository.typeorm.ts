...
export class UserRepositoryTypeorm {
    constructor(
        ...
        @InjectRepository(UsersConfirmationEmail) private userConfirmationRepository: Repository<UsersConfirmationEmail>,
        @InjectRepository(UsersPassword) private userPasswordRepository: Repository<UsersPassword>,
    ) { }
