...
export class QuestPagniation extends DefaultPagination {
    constructor(
        private queryParam: QuestionQueryParam
    ) {
        super(
            queryParam.pageSize,
    ...
    getQuestPaginationForSql() {
        ...
        const publishedStatus = this.getPublishedStatus(this.queryParam.publishedStatus)
        const bodySearchTerm = this.queryParam.bodySearchTerm ?? QUERY_PARAM_SQL.SEARCH_NAME_TERM
